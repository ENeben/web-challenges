...
//Option 2, more simple (to Sorted with reversed comparison symbols)
const animalsSortedByWeightReversedMoreSimple = animals.toSorted((a, b) => {
  if (a.weight > b.weight) {
    return -1;
  } else if (a.weight < b.weight) {
    return 1;
...
console.log(
  "animalsSortedByWeightReversedMoreSimple: ",
  animalsSortedByWeightReversedMoreSimple
);
...
//Option 2, used several variables:
const arrayAnimalsInAfrica = animals.filter((animal) =>
  animal.continents.includes("Africa")
);
const arrayWeightOfAnimalsInAfrica = arrayAnimalsInAfrica.map(
  (animal) => animal.weight
);
const addedWeightOfAnimalsInAfrica = arrayWeightOfAnimalsInAfrica.reduce(
  (a, b) => a + b
);
const averageWeightOfAllAnimalsInAfricaUsedVariables =
  addedWeightOfAnimalsInAfrica / arrayAnimalsInAfrica.length;

console.log(
  "averageWeightOfAllAnimalsInAfricaUsedVariables: ",
  averageWeightOfAllAnimalsInAfricaUsedVariables
);
