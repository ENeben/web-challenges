...
//TRY OUT the filter-method instead to return ALL the employees with the given last name:

function filterByLastName(employees, lastName) {
  return employees.filter((employee) => employee.lastName === lastName);
}
console.log("filterByLastName: ", filterByLastName(employees, "Ciabatti")); // 2 persons
