...
console.log("First task: ", onlyCardWithIdTwo);

const allCardsWith3Tags = cards.filter((card) => card.tags.length === 3);
console.log("Second task: ", allCardsWith3Tags);

const allCardsThatAreNotBookmarked = cards.filter((card) => !card.isBookmarked);
console.log("Third task: ", allCardsThatAreNotBookmarked);
...
console.log("Fourth task: ", allCardsWithTagsHTMLOrJSThatAreBookmarked);
