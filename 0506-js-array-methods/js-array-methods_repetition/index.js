...
console.log("Third task: ", timePerServing);
// [20, 10, 432, 12]
...
console.log("Fourth task: ", allTitlesInOneString);
...
console.log("Fifth task: ", recipesThatOnlyTake60minutesOrLess);

const allRecipesWithMoreThan2Servings = recipes.filter(
  (recipe) => recipe.servings > 2
);
console.log("Sixth task: ", allRecipesWithMoreThan2Servings);

const allRecipesWithTitlesLongerThan12Characters = recipes.filter(
  (recipe) => recipe.title.length > 12
);
console.log("Seventh task: ", allRecipesWithTitlesLongerThan12Characters);
